    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_aprv_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(ReviewedActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            action.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (status.equals("2")) {
                        ...
                        {
                            Toast.makeText(ReviewedActivity.this, "You can't reject", Toast.LENGTH_SHORT).show();
                        }
                        else {

                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(ReviewedActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
